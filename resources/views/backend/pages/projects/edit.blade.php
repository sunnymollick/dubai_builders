<form id='edit' action="" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="needs-validation"
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-12 col-sm-12">
            ...
            <input type="text" class="form-control" id="project_problem" name="project_problem" value="{{$project->project_problem}}" placeholder="" >
            <span id="error_title" class="has-error"></span>
        </div>
        <div class="clearfix"></div>
        ...
        <div class="form-group col-md-12 col-sm-12">
            ...
            <input type="file" class="form-control" id="hero_image" name="hero_image"  width="772" height="978">
            <span id="error_title" class="has-error"></span>
        </div>
        <div class="clearfix"></div>
