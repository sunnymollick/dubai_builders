        ...
        $('.view-chat').on('click', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('.chat-details').append('<div class="chat-header d-flex align-items-center"><div class="chat-toggle-btn"><i class="bx bx-menu-alt-left"></i></div><div><h4 class="mb-1 font-weight-bold">' + data.name + '</h4><div class="list-inline d-sm-flex mb-0 d-none"><a href="javascript:;" class="list-inline-item d-flex align-items-center text-secondary"><i class="bx bx-envelope me-1"></i>' + data.email + '</a><a href="javascript:;" class="list-inline-item d-flex align-items-center text-secondary">|</a><a href="javascript:;" class="list-inline-item d-flex align-items-center text-secondary"><i class="bx bx-phone me-1"></i>' + data.phone + '</a></div></div></div><div class="chat-content"><div class="chat-content-leftside"><div class="d-flex"><img src="{{asset("backend/")}}/images/avatars/266033.png" width="30" height="30" class="rounded-circle" alt /><div class="flex-grow-1 ms-2"><p class="mb-0 chat-time">' + data.name + ', ' + formattedTime + '</p><p class="chat-left-msg">' + data.message + '</p></div></div></div></div><div class="chat-footer d-flex align-items-center"><div class="flex-grow-1 pe-2"><div class="input-group"> <span class="input-group-text"><i class="bx bx-smile"></i></span><input type="text" class="form-control" placeholder="Type a message"></div></div><div class="chat-footer-menu"></div></div>')
