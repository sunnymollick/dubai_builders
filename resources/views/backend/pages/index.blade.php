...
<div class="row">
    ...
    <div class="col-12 col-lg-4">
        <div class="card radius-10 bg-gradient-burning">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <img src="{{ asset('backend') }}/images/icons/appointment-book.png" width="45"
                        alt="" />
        ...
        <div class="card radius-10 bg-gradient-blues">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <img src="{{ asset('backend') }}/images/icons/surgery.png" width="45"
                        alt="" />
                    <div class="ms-auto text-end">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <p class="mb-0 ms-auto"><i
                            class='bx bx-dots-horizontal-rounded float-end font-24'></i>
                    </p>
                </div>
                <div class="d-flex align-items-center mt-3">
                    <img src="{{ asset('backend') }}/images/avatars/avatar-1.png" width="45"
                        height="45" class="rounded-circle" alt="" />
                    <div class="flex-grow-1 ms-3">
                        <p class="mb-0"><span
                                class="badge badge-pill bg-light-danger text-danger">4.9</span>
                        </p>
                        <p class="font-weight-bold mb-0">Dr. Neil Wagner</p>
                        <p class="text-secondary mb-0">Pediatrician</p>
                    </div> <a href="javaScript:;"
                        class="btn btn-sm btn-outline-primary radius-10">Schedule</a>
                </div>
                <hr />
                <div class="d-flex align-items-center">
                    <img src="{{ asset('backend') }}/images/avatars/avatar-2.png" width="45"
                        height="45" class="rounded-circle" alt="" />
                    <div class="flex-grow-1 ms-3">
                        <p class="mb-0"><span
                                class="badge badge-pill bg-light-danger text-danger">3.5</span>
                        </p>
                ...
                <hr />
                <div class="d-flex align-items-center">
                    <img src="{{ asset('backend') }}/images/avatars/avatar-3.png" width="45"
                        height="45" class="rounded-circle" alt="" />
                    <div class="flex-grow-1 ms-3">
                        <p class="mb-0"><span
                                class="badge badge-pill bg-light-danger text-danger">5.2</span>
                        </p>
                ...
                <hr />
                <div class="d-flex align-items-center">
                    <img src="{{ asset('backend') }}/images/avatars/avatar-4.png" width="45"
                        height="45" class="rounded-circle" alt="" />
                    <div class="flex-grow-1 ms-3">
                        <p class="mb-0"><span
                                class="badge badge-pill bg-light-danger text-danger">8.9</span>
                        </p>
