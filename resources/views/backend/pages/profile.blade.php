                            ...
                            <div class="btn-group">
                                ...
                                <div
                                    ...
                                    <a class="dropdown-item" href="javascript:;">Another
                                        action</a>
                                    <a class="dropdown-item" href="javascript:;">Something
                                        else here</a>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div
                                                ...
                                                <img
                                                    src="{{asset('backend')}}/images/avatars/avatar-2.png"
                                                    alt="Admin"
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <p
                                                        class="text-muted font-size-sm">Bay
                                                        Area, San Francisco, CA</p>
                                                    <button
                                            ...
                                            <ul
                                                ...
                                                <li
                                                    ...
                                                    <h6 class="mb-0"><svg
                                                            ...
                                                            class="feather feather-globe me-2 icon-inline"><circle
                                                                cx="12" cy="12"
                                                                r="10"></circle><line
                                                                x1="2" y1="12"
                                                                x2="22" y2="12"></line><path
                                                                d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>Website</h6>
                                                ...
                                                <li
                                                    ...
                                                    <h6 class="mb-0"><svg
                                                            ...
                                                            class="feather feather-twitter me-2 icon-inline text-info"><path
                                                                d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg>Twitter</h6>
                                                    <span class="text-secondary">@codervent</span>
                                                </li>
                                                <li
                                                    class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
