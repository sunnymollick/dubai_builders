...
class ItemController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if ($request->ajax()) {
            $view = View::make('backend.pages.item_works.create', compact('work_categories'))->render();
        ...
        if ($request->ajax()) {
            ...
            if ($validator->fails()) {
                ...
                try {
                    ...
                    $item_work->unit = $request->input('unit');
    ...
    public function edit($id, Request $request)
    {
        ...
        $work_categories = WorkCategory::all();
        if ($request->ajax()) {
            $view = View::make('backend.pages.item_works.edit', compact('item_work', 'work_categories'))->render();
            return response()->json(['html' => $view]);
        } else {
            return response()->json(['status' => 'false', 'message' => "Access only ajax request"]);
        }
